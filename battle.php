...
$battleResult = $battleManager->battle($ship1, $ship1Quantity, $ship2,
    $ship2Quantity, $battleType);
?>
...
<div class="container">
    ...
    <div class="result-box center-block">
        ...
        <p class="text-center">
            ...
            <?php else: ?>
                ...
                <?php else: ?>
                    overpowered and destroyed the <?php echo $battleResult->getLosingShip()
                        ->getName() ?>s
                <?php endif; ?>
            <?php endif; ?>
        </p>
    ...
    <a href="/index.php"><p class="text-center"><i class="fa fa-undo"></i>
            Battle again</p></a>
