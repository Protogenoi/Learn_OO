...
if (isset($_GET['error'])) {
    switch ($_GET['error']) {
        ...
        case 'bad_ships':
            $errorMessage
                = 'You\'re trying to fight with a ship that\'s unknown to the galaxy?';
            break;
        case 'bad_quantities':
            $errorMessage
                = 'You pick strange numbers of ships to battle - try again.';
            break;
        default:
...
<div class="container">
    ...
    <table class="table table-hover">
        <caption><i class="fa fa-rocket"></i> These ships are ready for their
            next Mission
        </caption>
        <thead>
        <tr>
    ...
    <div class="battle-box center-block border">
        <div>
            <form method="POST" action="/battle.php">
                ...
                <input class="center-block form-control text-field" type="text"
                       name="ship1_quantity"
                ...
                <div class="text-center">
                    ...
                    <select name="battle_type" id="battle_type"
                            class="form-control drp-dwn-width center-block">
                        <option value="<?php echo BattleManager::TYPE_NORMAL; ?>">
                            Normal
                        </option>
                        <option value="<?php echo BattleManager::TYPE_NO_JEDI; ?>">
                            No Jedi Powers
                        </option>
                        <option value="<?php echo BattleManager::TYPE_ONLY_JEDI; ?>">
                            Only Jedi Powers
                        </option>
                    </select>
                </div>
                <br/>
                <button class="btn btn-md btn-danger center-block"
                        type="submit">Engage
                </button>
            </form>
        </div>
